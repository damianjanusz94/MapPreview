...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QWinWidget_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_QWinWidget_t qt_meta_stringdata_QWinWidget = {
    {
        QT_MOC_LITERAL(0, 10)   // "QWinWidget"
    },
    "QWinWidget"
};
...
const QMetaObject QWinWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_QWinWidget.offsetsAndSizes,
    qt_meta_data_QWinWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QWinWidget_t
, QtPrivate::TypeAndForceComplete<QWinWidget, std::true_type>
