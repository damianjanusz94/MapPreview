...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QWinHost_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_QWinHost_t qt_meta_stringdata_QWinHost = {
    {
        QT_MOC_LITERAL(0, 8)   // "QWinHost"
    },
    "QWinHost"
};
...
const QMetaObject QWinHost::staticMetaObject = { {
    ...
    qt_meta_stringdata_QWinHost.offsetsAndSizes,
    qt_meta_data_QWinHost,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QWinHost_t
, QtPrivate::TypeAndForceComplete<QWinHost, std::true_type>
