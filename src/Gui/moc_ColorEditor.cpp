...
void ColorEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ColorEditor::*)();
            if (_t _q_method = &ColorEditor::editingFinished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ColorEditor::staticMetaObject = { {
    ...
    qt_meta_stringdata_ColorEditor.offsetsAndSizes,
    qt_meta_data_ColorEditor,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ColorEditor_t
, QtPrivate::TypeAndForceComplete<ColorEditor, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void ColorEditor::editingFinished()
{
