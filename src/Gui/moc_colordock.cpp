...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ColorDock_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_ColorDock_t qt_meta_stringdata_ColorDock = {
    {
        QT_MOC_LITERAL(0, 9),  // "ColorDock"
        QT_MOC_LITERAL(10, 15),  // "changeSizeHints"
        QT_MOC_LITERAL(26, 0)   // ""
    },
    "ColorDock",
    "changeSizeHints",
...
const QMetaObject ColorDock::staticMetaObject = { {
    ...
    qt_meta_stringdata_ColorDock.offsetsAndSizes,
    qt_meta_data_ColorDock,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ColorDock_t
, QtPrivate::TypeAndForceComplete<ColorDock, std::true_type>
